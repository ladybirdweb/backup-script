...
def SCP_Upload():
    try:
        ...
        private_key_path = '/test/id_rsa'  # Update with the path to your private key
        private_key = paramiko.RSAKey.from_private_key_file(private_key_path)

        # Connect to SCP server using the private key for authentication
        ssh.connect(FTP_HOST, port=FTP_PORT, username=FTP_USER, pkey=private_key)
